...
// Borrowed from https://github.com/VictoriaMetrics/VictoriaMetrics/tree/v1.81.2/lib/ingestserver/opentsdb
// Changes:
// 2022-09-18
// remove VictoriaMetrics logger library
// remove VictoriaMetrics metrics client library
// return error from MustStart
...
func MustStart(addr string, telnetInsertHandler func(r io.Reader) error, httpInsertHandler func(req *http.Request) error, host component.Host) (*Server, error) {
	...
	httpServer := opentsdbhttp.MustServe(lnHTTP, httpInsertHandler, host)
